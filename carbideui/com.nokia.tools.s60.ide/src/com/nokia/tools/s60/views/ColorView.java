...
public class ColorView extends PageBookView implements
		IContributedContentsView, ISelectionListener {

	public static final String ID = "com.nokia.tools.s60.views.ColorView";
	public static final String ICON_CONTEXT = "com.nokia.tools.s60.ide.colours_context"; 
	...
	protected IPage createDefaultPage(PageBook book) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(book, ICON_CONTEXT);
		return page;
	}
	...
	protected PageRec doCreatePage(IWorkbenchPart part) {
		...
		if (part instanceof Series60EditorPart) {
			ColorViewPage page = new ColorViewPage((IEditorPart) part);
	...
	public IWorkbenchPart getContributingPart() {
		...
		if (getCurrentPage() instanceof ColorViewPage) {
			ColorViewPage lp = (ColorViewPage) getCurrentPage();
