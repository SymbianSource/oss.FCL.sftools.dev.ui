...
public class Convert2ElevenBitmapCommand extends Series60EditorCommand{
	...
	public Convert2ElevenBitmapCommand(IContentData data, EditPart part,
			boolean fillParts) {
		super(data, part);
		setLabel(Messages.Convert2Eleven_Label);
	...
	protected void doExecute() {
		try {
			...
			//partUndoObjects = getAdapter().convertToElevenPieceBitmap(fillParts);
