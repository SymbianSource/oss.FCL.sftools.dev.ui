...
public class ElevenPieceOperationConfirmDialog extends BrandedTitleAreaDialog {

	public static final int TYPE_2ELEVEN = 11;

	public static final int TYPE_2SINGLE = 1;

	private int type;

	public ElevenPieceOperationConfirmDialog(Shell shell, int type) {
		super(shell);
	...
	private String getPrefKey() {
		return type == TYPE_2ELEVEN ? IMediaConstants.PREF_SINGLE_PIECE_2NINE_ASK
	...
	protected Control createDialogArea(Composite parent) {
		...
		ft
				.setText(type == TYPE_2ELEVEN ? Messages.ElevenPieceOperationConfirm_banner_message_11
	...
	protected String getTitle() {
		return type == TYPE_2ELEVEN ? Messages.NinePieceOperationConfirm_title_9
	...
	protected ImageDescriptor getBannerIconDescriptor() {
		...
		if (manager != null) {
			bannerIcon = (type == TYPE_2ELEVEN ? S60WorkspacePlugin
