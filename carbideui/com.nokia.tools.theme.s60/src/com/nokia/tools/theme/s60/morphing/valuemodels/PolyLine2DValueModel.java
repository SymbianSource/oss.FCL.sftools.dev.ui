...
public class PolyLine2DValueModel implements BaseValueModelInterface{
    ...
    public static PolyLine2DValueModel getInstance(){
        PolyLine2DValueModel self = new PolyLine2DValueModel();
        self.constructL();
        return self;
    }
