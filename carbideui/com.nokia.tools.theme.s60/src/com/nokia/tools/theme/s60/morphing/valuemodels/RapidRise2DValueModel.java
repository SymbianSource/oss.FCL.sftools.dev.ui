...
public class RapidRise2DValueModel implements BaseValueModelInterface{
    ...
    public static RapidRise2DValueModel getInstance(){
        RapidRise2DValueModel self = new RapidRise2DValueModel();
        self.constructL();
        return self;
    }
