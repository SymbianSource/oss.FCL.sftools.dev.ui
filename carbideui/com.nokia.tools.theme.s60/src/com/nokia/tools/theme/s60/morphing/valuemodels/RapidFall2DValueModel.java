...
public class RapidFall2DValueModel implements BaseValueModelInterface{
    ...
    public static RapidFall2DValueModel getInstance(){
        RapidFall2DValueModel self = new RapidFall2DValueModel();
        self.constructL();
        return self;
    }
