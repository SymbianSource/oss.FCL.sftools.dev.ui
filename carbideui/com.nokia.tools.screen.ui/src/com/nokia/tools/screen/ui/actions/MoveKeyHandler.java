...
public class MoveKeyHandler extends ConstraintKeyHandler {
	public MoveKeyHandler(IWorkbenchPart part) {
		super(part);
	}
	...
	protected Rectangle getNewConstraint(int keyCode, Rectangle bounds) {
		switch (keyCode) {
		case SWT.ARROW_LEFT:
			return new Rectangle(bounds.x - 1, bounds.y, bounds.width,
					bounds.height);
